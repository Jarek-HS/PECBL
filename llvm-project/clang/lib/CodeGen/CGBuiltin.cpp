...
RValue CodeGenFunction::EmitBuiltinExpr(const GlobalDecl GD, unsigned BuiltinID,
  ...
  if (GenerateIntrinsics) {
    ...
    case Builtin::BIrint:
    if (getLangOpts().Fposit) {
      llvm::Function *RintFn = getOrDeclarerintl(*this);
      CGCallee Callee = CGCallee::forDirect(RintFn, CGCalleeInfo{});
      return EmitWrappedPositBuiltinCall(*this, E, nullptr, Callee,
                                         ReturnValue, nullptr);
    }
      break;
    case Builtin::BIrintf:
    if (getLangOpts().Fposit) {
      llvm::Function *RintFn = getOrDeclarerint(*this);
      CGCallee Callee = CGCallee::forDirect(RintFn, CGCalleeInfo{});
      return EmitWrappedPositBuiltinCall(*this, E, nullptr, Callee,
                                         ReturnValue, nullptr);
    }
    ...
    if (getLangOpts().Fposit) {
      llvm::Function *NearbyintFn = getOrDeclarenearbyintl(*this);
      CGCallee Callee = CGCallee::forDirect(NearbyintFn, CGCalleeInfo{});
      return EmitWrappedPositBuiltinCall(*this, E, nullptr, Callee,
                                         ReturnValue, nullptr);
    }
      break;
    ...
    if (getLangOpts().Fposit) {
      llvm::Function *NearbyintFn = getOrDeclarenearbyint(*this);
      CGCallee Callee = CGCallee::forDirect(NearbyintFn, CGCalleeInfo{});
      return EmitWrappedPositBuiltinCall(*this, E, nullptr, Callee,
                                         ReturnValue, nullptr);
    }
    ...
    if (getLangOpts().Fposit) {
      llvm::Function *CopysignFn = getOrDeclarecopysignl(*this);
      CGCallee Callee = CGCallee::forDirect(CopysignFn, CGCalleeInfo{});
      return EmitWrappedPositBuiltinCall(*this, E, nullptr, Callee,
                                         ReturnValue, nullptr);
    }
      break;
    ...
    if (getLangOpts().Fposit) {
      llvm::Function *CopysignFn = getOrDeclarecopysign(*this);
      CGCallee Callee = CGCallee::forDirect(CopysignFn, CGCalleeInfo{});
      return EmitWrappedPositBuiltinCall(*this, E, nullptr, Callee,
                                         ReturnValue, nullptr);
    }
    ...
    case Builtin::BIceil:
        if (getLangOpts().Fposit) {
        llvm::Function *CeillFn = getOrDeclareceill(*this);
        CGCallee Callee = CGCallee::forDirect(CeillFn, CGCalleeInfo{});
        return EmitWrappedPositBuiltinCall(*this, E, nullptr, Callee, ReturnValue, nullptr);
      }
      break;
    case Builtin::BIceilf:
      if (getLangOpts().Fposit) {
        llvm::Function *CeilFn = getOrDeclareceil(*this);
        CGCallee Callee = CGCallee::forDirect(CeilFn, CGCalleeInfo{});
        return EmitWrappedPositBuiltinCall(*this, E, nullptr, Callee, ReturnValue, nullptr);
      }
      break;
    ...
    case Builtin::BIfabs:
    if (getLangOpts().Fposit) {
      llvm::Function *FabslFn = getOrDeclarefabsl(*this); // 從 PositCallRewrite.cpp 提供的工具取得正確型別的 fabsl 函式
      CGCallee Callee = CGCallee::forDirect(FabslFn, CGCalleeInfo{});
      return EmitWrappedPositBuiltinCall(*this, E, nullptr, Callee, ReturnValue, nullptr);
    }
    break;
    ...
    if (getLangOpts().Fposit) {
      llvm::Function *FabslFn = getOrDeclarefabs(*this); // 從 PositCallRewrite.cpp 提供的工具取得正確型別的 fabsl 函式
      CGCallee Callee = CGCallee::forDirect(FabslFn, CGCalleeInfo{});
      return EmitWrappedPositBuiltinCall(*this, E, nullptr, Callee, ReturnValue, nullptr);
    }
    break;
    ...
    case Builtin::BIfloor:
        if (getLangOpts().Fposit) {
          llvm::Function *FloorlFn = getOrDeclarefloorl(*this);
          CGCallee Callee = CGCallee::forDirect(FloorlFn, CGCalleeInfo{});
          return EmitWrappedPositBuiltinCall(*this, E, nullptr, Callee, ReturnValue, nullptr);
        }
        break;
    case Builtin::BIfloorf:
        if (getLangOpts().Fposit) {
          llvm::Function *FloorFn = getOrDeclarefloor(*this);
          CGCallee Callee = CGCallee::forDirect(FloorFn, CGCalleeInfo{});
          return EmitWrappedPositBuiltinCall(*this, E, nullptr, Callee, ReturnValue, nullptr);
        }
        break;
    ...
    case Builtin::BIlog2:
    if (getLangOpts().Fposit) {
      llvm::Function *Log2lFn = getOrDeclarelog2l(*this);
      CGCallee Callee = CGCallee::forDirect(Log2lFn, CGCalleeInfo{});
      return EmitWrappedPositBuiltinCall(*this, E, nullptr, Callee, ReturnValue, nullptr);
    }
    break;
    case Builtin::BIlog2f:
    if (getLangOpts().Fposit) {
      llvm::Function *Log2Fn = getOrDeclarelog2(*this);
      CGCallee Callee = CGCallee::forDirect(Log2Fn, CGCalleeInfo{});
      return EmitWrappedPositBuiltinCall(*this, E, nullptr, Callee, ReturnValue, nullptr);
    }
    break;
    case Builtin::BIlog2l:
    case Builtin::BI__builtin_log2:
    llvm::errs() << "BI__builtin_log2l is not supported in Posit\n";
    ...
    if (getLangOpts().Fposit) {
      llvm::Function *RoundlFn = getOrDeclareroundl(*this);
      CGCallee Callee = CGCallee::forDirect(RoundlFn, CGCalleeInfo{});
      return EmitWrappedPositBuiltinCall(*this, E, nullptr, Callee, ReturnValue, nullptr);
    }
    break;
    case Builtin::BIroundf:
    if (getLangOpts().Fposit) {
      llvm::Function *RoundFn = getOrDeclareround(*this);
      CGCallee Callee = CGCallee::forDirect(RoundFn, CGCalleeInfo{});
      return EmitWrappedPositBuiltinCall(*this, E, nullptr, Callee, ReturnValue, nullptr);
    }
    break;
    ...
    if (getLangOpts().Fposit) {
      llvm::Function *TrunclFn = getOrDeclaretruncl(*this);
      CGCallee Callee = CGCallee::forDirect(TrunclFn, CGCalleeInfo{});
      return EmitWrappedPositBuiltinCall(*this, E, nullptr, Callee, ReturnValue, nullptr);
    }
    break;
    case Builtin::BItruncf:
    if (getLangOpts().Fposit) {
      llvm::Function *TruncFn = getOrDeclaretrunc(*this);
      CGCallee Callee = CGCallee::forDirect(TruncFn, CGCalleeInfo{});
      return EmitWrappedPositBuiltinCall(*this, E, nullptr, Callee, ReturnValue, nullptr);
    }
    break;
  ...
  default: break;
  //============================================================//
  //posit builtin Trigonometric
  //============================================================//
  case Builtin::BIsin:
  if (getLangOpts().Fposit) {
    llvm::Function *SinlFn = getOrDeclaresinl(*this); 
    CGCallee Callee = CGCallee::forDirect(SinlFn, CGCalleeInfo{});
    return EmitWrappedPositBuiltinCall(*this, E, nullptr, Callee, ReturnValue, nullptr);
  }
  break;
  case Builtin::BIsinf:
  if (getLangOpts().Fposit) {
    llvm::Function *SinFn = getOrDeclaresin(*this); 
    CGCallee Callee = CGCallee::forDirect(SinFn, CGCalleeInfo{});
    return EmitWrappedPositBuiltinCall(*this, E, nullptr, Callee, ReturnValue, nullptr);
  }
  break;
  case Builtin::BIcos:
  if (getLangOpts().Fposit) {
    llvm::Function *CoslFn = getOrDeclarecosl(*this); 
    CGCallee Callee = CGCallee::forDirect(CoslFn, CGCalleeInfo{});
    return EmitWrappedPositBuiltinCall(*this, E, nullptr, Callee, ReturnValue, nullptr);
  }
  break;
  case Builtin::BIcosf:
  if (getLangOpts().Fposit) {
    llvm::Function *CosFn = getOrDeclarecos(*this); 
    CGCallee Callee = CGCallee::forDirect(CosFn, CGCalleeInfo{});
    return EmitWrappedPositBuiltinCall(*this, E, nullptr, Callee, ReturnValue, nullptr);
  }
  break;
  case Builtin::BItan:
  if (getLangOpts().Fposit) {
    llvm::Function *TanlFn = getOrDeclaretanl(*this); 
    CGCallee Callee = CGCallee::forDirect(TanlFn, CGCalleeInfo{});
    return EmitWrappedPositBuiltinCall(*this, E, nullptr, Callee, ReturnValue, nullptr);
  }
  break;
  case Builtin::BItanf:
  if (getLangOpts().Fposit) {
    llvm::Function *TanFn = getOrDeclaretan(*this); 
    CGCallee Callee = CGCallee::forDirect(TanFn, CGCalleeInfo{});
    return EmitWrappedPositBuiltinCall(*this, E, nullptr, Callee, ReturnValue, nullptr);
  }
  break;
  case Builtin::BIasin:
  if (getLangOpts().Fposit) {
    llvm::Function *ASinlFn = getOrDeclareasinl(*this); 
    CGCallee Callee = CGCallee::forDirect(ASinlFn, CGCalleeInfo{});
    return EmitWrappedPositBuiltinCall(*this, E, nullptr, Callee, ReturnValue, nullptr);
  }
  break;
  case Builtin::BIasinf:
  if (getLangOpts().Fposit) {
    llvm::Function *ASinFn = getOrDeclareasin(*this); 
    CGCallee Callee = CGCallee::forDirect(ASinFn, CGCalleeInfo{});
    return EmitWrappedPositBuiltinCall(*this, E, nullptr, Callee, ReturnValue, nullptr);
  }
  break;
  case Builtin::BIacos:
  if (getLangOpts().Fposit) {
    llvm::Function *ACoslFn = getOrDeclareacosl(*this); 
    CGCallee Callee = CGCallee::forDirect(ACoslFn, CGCalleeInfo{});
    return EmitWrappedPositBuiltinCall(*this, E, nullptr, Callee, ReturnValue, nullptr);
  }
  break;
  case Builtin::BIacosf:
  if (getLangOpts().Fposit) {
    llvm::Function *ACosFn = getOrDeclareacos(*this); 
    CGCallee Callee = CGCallee::forDirect(ACosFn, CGCalleeInfo{});
    return EmitWrappedPositBuiltinCall(*this, E, nullptr, Callee, ReturnValue, nullptr);
  }
  break;
  case Builtin::BIatan:
  if (getLangOpts().Fposit) {
    llvm::Function *ATanlFn = getOrDeclareatanl(*this); 
    CGCallee Callee = CGCallee::forDirect(ATanlFn, CGCalleeInfo{});
    return EmitWrappedPositBuiltinCall(*this, E, nullptr, Callee, ReturnValue, nullptr);
  }
  break;
  case Builtin::BIatanf:
  if (getLangOpts().Fposit) {
    llvm::Function *ATanFn = getOrDeclareatan(*this); 
    CGCallee Callee = CGCallee::forDirect(ATanFn, CGCalleeInfo{});
    return EmitWrappedPositBuiltinCall(*this, E, nullptr, Callee, ReturnValue, nullptr);
  }
  break;
  case Builtin::BIatan2:
  if (getLangOpts().Fposit) {
    llvm::Function *ATan2lFn = getOrDeclareatan2l(*this); 
    CGCallee Callee = CGCallee::forDirect(ATan2lFn, CGCalleeInfo{});
    return EmitWrappedPositBuiltinCall(*this, E, nullptr, Callee, ReturnValue, nullptr);
  }
  break;
  case Builtin::BIatan2f:
  if (getLangOpts().Fposit) {
    llvm::Function *ATan2Fn = getOrDeclareatan2(*this); 
    CGCallee Callee = CGCallee::forDirect(ATan2Fn, CGCalleeInfo{});
    return EmitWrappedPositBuiltinCall(*this, E, nullptr, Callee, ReturnValue, nullptr);
  }
  break;

  //============================================================//
  // posit builtin Hyperbolic
  //============================================================//
  case Builtin::BIsinh:
  if (getLangOpts().Fposit) {
    llvm::Function *SinhlFn = getOrDeclaresinhl(*this); 
    CGCallee Callee = CGCallee::forDirect(SinhlFn, CGCalleeInfo{});
    return EmitWrappedPositBuiltinCall(*this, E, nullptr, Callee, ReturnValue, nullptr);
  }
  break;
  case Builtin::BIsinhf:
  if (getLangOpts().Fposit) {
    llvm::Function *SinhFn = getOrDeclaresinh(*this); 
    CGCallee Callee = CGCallee::forDirect(SinhFn, CGCalleeInfo{});
    return EmitWrappedPositBuiltinCall(*this, E, nullptr, Callee, ReturnValue, nullptr);
  }
  break;
  case Builtin::BIcosh:
  if (getLangOpts().Fposit) {
    llvm::Function *CoshlFn = getOrDeclarecoshl(*this); 
    CGCallee Callee = CGCallee::forDirect(CoshlFn, CGCalleeInfo{});
    return EmitWrappedPositBuiltinCall(*this, E, nullptr, Callee, ReturnValue, nullptr);
  }
  break;
  case Builtin::BIcoshf:
  if (getLangOpts().Fposit) {
    llvm::Function *CoshFn = getOrDeclarecosh(*this); 
    CGCallee Callee = CGCallee::forDirect(CoshFn, CGCalleeInfo{});
    return EmitWrappedPositBuiltinCall(*this, E, nullptr, Callee, ReturnValue, nullptr);
  }
  break;
  case Builtin::BItanh:
  if (getLangOpts().Fposit) {
    llvm::Function *TanhlFn = getOrDeclaretanhl(*this); 
    CGCallee Callee = CGCallee::forDirect(TanhlFn, CGCalleeInfo{});
    return EmitWrappedPositBuiltinCall(*this, E, nullptr, Callee, ReturnValue, nullptr);
  }
  break;
  case Builtin::BItanhf:
  if (getLangOpts().Fposit) {
    llvm::Function *TanhFn = getOrDeclaretanh(*this); 
    CGCallee Callee = CGCallee::forDirect(TanhFn, CGCalleeInfo{});
    return EmitWrappedPositBuiltinCall(*this, E, nullptr, Callee, ReturnValue, nullptr);
  }
  break;
  case Builtin::BIasinh:
  if (getLangOpts().Fposit) {
    llvm::Function *ASinhlFn = getOrDeclareasinhl(*this); 
    CGCallee Callee = CGCallee::forDirect(ASinhlFn, CGCalleeInfo{});
    return EmitWrappedPositBuiltinCall(*this, E, nullptr, Callee, ReturnValue, nullptr);
  }
  break;
  case Builtin::BIasinhf:
  if (getLangOpts().Fposit) {
    llvm::Function *ASinhFn = getOrDeclareasinh(*this); 
    CGCallee Callee = CGCallee::forDirect(ASinhFn, CGCalleeInfo{});
    return EmitWrappedPositBuiltinCall(*this, E, nullptr, Callee, ReturnValue, nullptr);
  }
  break;
  case Builtin::BIacosh:
  if (getLangOpts().Fposit) {
    llvm::Function *ACoshlFn = getOrDeclareacoshl(*this); 
    CGCallee Callee = CGCallee::forDirect(ACoshlFn, CGCalleeInfo{});
    return EmitWrappedPositBuiltinCall(*this, E, nullptr, Callee, ReturnValue, nullptr);
  }
  break;
  case Builtin::BIacoshf:
  if (getLangOpts().Fposit) {
    llvm::Function *ACoshFn = getOrDeclareacosh(*this); 
    CGCallee Callee = CGCallee::forDirect(ACoshFn, CGCalleeInfo{});
    return EmitWrappedPositBuiltinCall(*this, E, nullptr, Callee, ReturnValue, nullptr);
  }
  break;
  case Builtin::BIatanh:
  if (getLangOpts().Fposit) {
    llvm::Function *ATanhlFn = getOrDeclareatanhl(*this); 
    CGCallee Callee = CGCallee::forDirect(ATanhlFn, CGCalleeInfo{});
    return EmitWrappedPositBuiltinCall(*this, E, nullptr, Callee, ReturnValue, nullptr);
  }
  break;
  case Builtin::BIatanhf:
  if (getLangOpts().Fposit) {
    llvm::Function *ATanhFn = getOrDeclareatanh(*this); 
    CGCallee Callee = CGCallee::forDirect(ATanhFn, CGCalleeInfo{});
    return EmitWrappedPositBuiltinCall(*this, E, nullptr, Callee, ReturnValue, nullptr);
  }
  break;
  case Builtin::BIexp:
  if (getLangOpts().Fposit) {
    llvm::Function *ExplFn = getOrDeclareexpl(*this); 
    CGCallee Callee = CGCallee::forDirect(ExplFn, CGCalleeInfo{});
    return EmitWrappedPositBuiltinCall(*this, E, nullptr, Callee, ReturnValue, nullptr);
  }
  break;
  case Builtin::BIexpf:
  if (getLangOpts().Fposit) {
    llvm::Function *ExpFn = getOrDeclareexp(*this); 
    CGCallee Callee = CGCallee::forDirect(ExpFn, CGCalleeInfo{});
    return EmitWrappedPositBuiltinCall(*this, E, nullptr, Callee, ReturnValue, nullptr);
  }
  break;
  
  //============================================================//
  // posit builtin Exponential
  //============================================================//
  case Builtin::BIlog:
  if (getLangOpts().Fposit) {
    llvm::Function *LoglFn = getOrDeclarelogl(*this); 
    CGCallee Callee = CGCallee::forDirect(LoglFn, CGCalleeInfo{});
    return EmitWrappedPositBuiltinCall(*this, E, nullptr, Callee, ReturnValue, nullptr);
  }
  break;
  case Builtin::BIlogf:
  if (getLangOpts().Fposit) {
    llvm::Function *LogFn = getOrDeclarelog(*this); 
    CGCallee Callee = CGCallee::forDirect(LogFn, CGCalleeInfo{});
    return EmitWrappedPositBuiltinCall(*this, E, nullptr, Callee, ReturnValue, nullptr);
  }
  break;
  case Builtin::BIlog10:
  if (getLangOpts().Fposit) {
    llvm::Function *Log10lFn = getOrDeclarelog10l(*this); 
    CGCallee Callee = CGCallee::forDirect(Log10lFn, CGCalleeInfo{});
    return EmitWrappedPositBuiltinCall(*this, E, nullptr, Callee, ReturnValue, nullptr);
  }
  break;
  case Builtin::BIlog10f:
  if (getLangOpts().Fposit) {
    llvm::Function *Log10Fn = getOrDeclarelog10(*this); 
    CGCallee Callee = CGCallee::forDirect(Log10Fn, CGCalleeInfo{});
    return EmitWrappedPositBuiltinCall(*this, E, nullptr, Callee, ReturnValue, nullptr);
  }
  break;
  case Builtin::BIlog1p:
  if (getLangOpts().Fposit) {
    llvm::Function *Log1plFn = getOrDeclarelog1pl(*this); 
    CGCallee Callee = CGCallee::forDirect(Log1plFn, CGCalleeInfo{});
    return EmitWrappedPositBuiltinCall(*this, E, nullptr, Callee, ReturnValue, nullptr);
  }
  break;
  case Builtin::BIlog1pf:
  if (getLangOpts().Fposit) {
    llvm::Function *Log1pFn = getOrDeclarelog1p(*this); 
    CGCallee Callee = CGCallee::forDirect(Log1pFn, CGCalleeInfo{});
    return EmitWrappedPositBuiltinCall(*this, E, nullptr, Callee, ReturnValue, nullptr);
  }
  break;
  //============================================================//
  ...
  case Builtin::BIpow:
  if (getLangOpts().Fposit) {
    llvm::Function *PowlFn = getOrDeclarepowl(*this); 
    CGCallee Callee = CGCallee::forDirect(PowlFn, CGCalleeInfo{});
    return EmitWrappedPositBuiltinCall(*this, E, nullptr, Callee, ReturnValue, nullptr);
  }
  break;
  case Builtin::BIpowf:
  if (getLangOpts().Fposit) {
    llvm::Function *PowFn = getOrDeclarepow(*this); 
    CGCallee Callee = CGCallee::forDirect(PowFn, CGCalleeInfo{});
    return EmitWrappedPositBuiltinCall(*this, E, nullptr, Callee, ReturnValue, nullptr);
  }
  break;
  case Builtin::BIsqrt:
  if (getLangOpts().Fposit) {
    llvm::Function *SqrtlFn = getOrDeclaresqrtl(*this); 
    CGCallee Callee = CGCallee::forDirect(SqrtlFn, CGCalleeInfo{});
    return EmitWrappedPositBuiltinCall(*this, E, nullptr, Callee, ReturnValue, nullptr);
  }
  break;
  case Builtin::BIsqrtf:
  if (getLangOpts().Fposit) {
    llvm::Function *SqrtFn = getOrDeclaresqrt(*this); 
    CGCallee Callee = CGCallee::forDirect(SqrtFn, CGCalleeInfo{});
    return EmitWrappedPositBuiltinCall(*this, E, nullptr, Callee, ReturnValue, nullptr);
  }
  break;
  //============================================================//
  ...
  case Builtin::BImodf:
  if (getLangOpts().Fposit) {
    llvm::Function *ModflFn = getOrDeclaremodfl(*this);
    CGCallee Callee = CGCallee::forDirect(ModflFn, CGCalleeInfo{});
    return EmitWrappedPositBuiltinCall(*this, E, nullptr, Callee, ReturnValue, nullptr);
  }
  break;
  case Builtin::BImodff:
  if (getLangOpts().Fposit) {
    llvm::Function *ModfFn = getOrDeclaremodf(*this);
    CGCallee Callee = CGCallee::forDirect(ModfFn, CGCalleeInfo{});
    return EmitWrappedPositBuiltinCall(*this, E, nullptr, Callee, ReturnValue, nullptr);
  }
  break;
  ...
  case Builtin::BIfmod:
  if (getLangOpts().Fposit) {
    llvm::Function *FmodlFn = getOrDeclarefmodl(*this);
    CGCallee Callee = CGCallee::forDirect(FmodlFn, CGCalleeInfo{});
    return EmitWrappedPositBuiltinCall(*this, E, nullptr, Callee, ReturnValue, nullptr);
  }
  break;
  case Builtin::BIfmodf:
  if (getLangOpts().Fposit) {
    llvm::Function *FmodFn = getOrDeclarefmod(*this);
    CGCallee Callee = CGCallee::forDirect(FmodFn, CGCalleeInfo{});
    return EmitWrappedPositBuiltinCall(*this, E, nullptr, Callee, ReturnValue, nullptr);
  }
  break;
  //============================================================//
  ...
  break;
  //============================================================//
  // posit builtin Miscellaneous
  //============================================================//
  case Builtin::BIfma:
  if (getLangOpts().Fposit) {
    llvm::Function *FmalFn = getOrDeclarefmal(*this);
    CGCallee Callee = CGCallee::forDirect(FmalFn, CGCalleeInfo{});
    return EmitWrappedPositBuiltinCall(*this, E, nullptr, Callee, ReturnValue, nullptr);
  }
  break;
  case Builtin::BIfmaf:
  if (getLangOpts().Fposit) {
    llvm::Function *FmaFn = getOrDeclarefma(*this);
    CGCallee Callee = CGCallee::forDirect(FmaFn, CGCalleeInfo{});
    return EmitWrappedPositBuiltinCall(*this, E, nullptr, Callee, ReturnValue, nullptr);
  }
  break;
  ...
  if (getLangOpts().Fposit) {
    llvm::Function *HypotlFn = getOrDeclarehypotl(*this);
    CGCallee Callee = CGCallee::forDirect(HypotlFn, CGCalleeInfo{});
    return EmitWrappedPositBuiltinCall(*this, E, nullptr, Callee, ReturnValue, nullptr);
  }
  break;
  case Builtin::BIhypotf:
  if (getLangOpts().Fposit) {
    llvm::Function *HypotFn = getOrDeclarehypot(*this);
    CGCallee Callee = CGCallee::forDirect(HypotFn, CGCalleeInfo{});
    return EmitWrappedPositBuiltinCall(*this, E, nullptr, Callee, ReturnValue, nullptr);
  }
  break;
  ...
  case Builtin::BIcbrt:
  if (getLangOpts().Fposit) {
    llvm::Function *CbrtlFn = getOrDeclarecbrtl(*this);
    CGCallee Callee = CGCallee::forDirect(CbrtlFn, CGCalleeInfo{});
    return EmitWrappedPositBuiltinCall(*this, E, nullptr, Callee, ReturnValue, nullptr);
  }
  break;
  case Builtin::BIcbrtf:
  if (getLangOpts().Fposit) {
    llvm::Function *CbrtFn = getOrDeclarecbrt(*this);
    CGCallee Callee = CGCallee::forDirect(CbrtFn, CGCalleeInfo{});
    return EmitWrappedPositBuiltinCall(*this, E, nullptr, Callee, ReturnValue, nullptr);
  }
  break;
  case Builtin::BIexpm1:
  if (getLangOpts().Fposit) {
    llvm::Function *Expm1lFn = getOrDeclareexpm1l(*this);
    CGCallee Callee = CGCallee::forDirect(Expm1lFn, CGCalleeInfo{});
    return EmitWrappedPositBuiltinCall(*this, E, nullptr, Callee, ReturnValue, nullptr);
  }
  break;
  case Builtin::BIexpm1f:
  if (getLangOpts().Fposit) {
    llvm::Function *Expm1Fn = getOrDeclareexpm1(*this);
    CGCallee Callee = CGCallee::forDirect(Expm1Fn, CGCalleeInfo{});
    return EmitWrappedPositBuiltinCall(*this, E, nullptr, Callee, ReturnValue, nullptr);
  }
  break;
  case Builtin::BIremainder:
  if (getLangOpts().Fposit) {
    llvm::Function *RemainderlFn = getOrDeclareremainderl(*this);
    CGCallee Callee = CGCallee::forDirect(RemainderlFn, CGCalleeInfo{});
    return EmitWrappedPositBuiltinCall(*this, E, nullptr, Callee, ReturnValue, nullptr);
  }
  break;
  case Builtin::BIremainderf:
  if (getLangOpts().Fposit) {
    llvm::Function *RemainderFn = getOrDeclareremainder(*this);
    CGCallee Callee = CGCallee::forDirect(RemainderFn, CGCalleeInfo{});
    return EmitWrappedPositBuiltinCall(*this, E, nullptr, Callee, ReturnValue, nullptr);
  }
  break; 
  case Builtin::BIremquo:
  if (getLangOpts().Fposit) {
    llvm::Function *RemQuolFn = getOrDeclareremquol(*this);
    CGCallee Callee = CGCallee::forDirect(RemQuolFn, CGCalleeInfo{});
    return EmitWrappedPositBuiltinCall(*this, E, nullptr, Callee, ReturnValue, nullptr);
  }
  break;
  case Builtin::BIremquof:
  if (getLangOpts().Fposit) {
    llvm::Function *RemQuoFn = getOrDeclareremquo(*this);
    CGCallee Callee = CGCallee::forDirect(RemQuoFn, CGCalleeInfo{});
    return EmitWrappedPositBuiltinCall(*this, E, nullptr, Callee, ReturnValue, nullptr);
  }
  break;
  case Builtin::BInextafter:
  if (getLangOpts().Fposit) {
    llvm::Function *NextAfterlFn = getOrDeclarenextafterl(*this);
    CGCallee Callee = CGCallee::forDirect(NextAfterlFn, CGCalleeInfo{});
    return EmitWrappedPositBuiltinCall(*this, E, nullptr, Callee, ReturnValue, nullptr);
  }
  break;
  case Builtin::BInextafterf:
  if (getLangOpts().Fposit) {
    llvm::Function *NextAfterFn = getOrDeclarenextafter(*this);
    CGCallee Callee = CGCallee::forDirect(NextAfterFn, CGCalleeInfo{});
    return EmitWrappedPositBuiltinCall(*this, E, nullptr, Callee, ReturnValue, nullptr);
  }
  break;
  case Builtin::BIfrexp:
  if (getLangOpts().Fposit) {
    llvm::Function *FrexplFn = getOrDeclarefrexpl(*this);
    CGCallee Callee = CGCallee::forDirect(FrexplFn, CGCalleeInfo{});
    return EmitWrappedPositBuiltinCall(*this, E, nullptr, Callee, ReturnValue, nullptr);
  }
  break;
  case Builtin::BIfrexpf:
  if (getLangOpts().Fposit) {
    llvm::Function *FrexpFn = getOrDeclarefrexp(*this);
    CGCallee Callee = CGCallee::forDirect(FrexpFn, CGCalleeInfo{});
    return EmitWrappedPositBuiltinCall(*this, E, nullptr, Callee, ReturnValue, nullptr);
  }
  break;
  case Builtin::BIldexp:
  if (getLangOpts().Fposit) {
    llvm::Function *LdexplFn = getOrDeclareldexpl(*this);
    CGCallee Callee = CGCallee::forDirect(LdexplFn, CGCalleeInfo{});
    return EmitWrappedPositBuiltinCall(*this, E, nullptr, Callee, ReturnValue, nullptr);
  }
  break;
  case Builtin::BIldexpf:
  if (getLangOpts().Fposit) {
    llvm::Function *LdexpFn = getOrDeclareldexp(*this);
    CGCallee Callee = CGCallee::forDirect(LdexpFn, CGCalleeInfo{});
    return EmitWrappedPositBuiltinCall(*this, E, nullptr, Callee, ReturnValue, nullptr);
  }
  break;
  case Builtin::BIscalbn:
  if (getLangOpts().Fposit) {
    llvm::Function *ScalbnlFn = getOrDeclarescalbnl(*this);
    CGCallee Callee = CGCallee::forDirect(ScalbnlFn, CGCalleeInfo{});
    return EmitWrappedPositBuiltinCall(*this, E, nullptr, Callee, ReturnValue, nullptr);
  }
  break;
  case Builtin::BIscalbnf:
  if (getLangOpts().Fposit) {
    llvm::Function *ScalbnFn = getOrDeclarescalbn(*this);
    CGCallee Callee = CGCallee::forDirect(ScalbnFn, CGCalleeInfo{});
    return EmitWrappedPositBuiltinCall(*this, E, nullptr, Callee, ReturnValue, nullptr);
  }
  break;
  case Builtin::BItgamma:
  if (getLangOpts().Fposit) {
    llvm::Function *TgammalFn = getOrDeclaretgammal(*this);
    CGCallee Callee = CGCallee::forDirect(TgammalFn, CGCalleeInfo{});
    return EmitWrappedPositBuiltinCall(*this, E, nullptr, Callee, ReturnValue, nullptr);
  }
  break;
  case Builtin::BItgammaf:
  if (getLangOpts().Fposit) {
    llvm::Function *TgammaFn = getOrDeclaretgamma(*this);
    CGCallee Callee = CGCallee::forDirect(TgammaFn, CGCalleeInfo{});
    return EmitWrappedPositBuiltinCall(*this, E, nullptr, Callee, ReturnValue, nullptr);
  }
  break;
  case Builtin::BIlgamma:
  if (getLangOpts().Fposit) {
    llvm::Function *LgammalFn = getOrDeclarelgammal(*this);
    CGCallee Callee = CGCallee::forDirect(LgammalFn, CGCalleeInfo{});
    return EmitWrappedPositBuiltinCall(*this, E, nullptr, Callee, ReturnValue, nullptr);
  }
  break;
  case Builtin::BIlgammaf:
  if (getLangOpts().Fposit) {
    llvm::Function *LgammalFn = getOrDeclarelgamma(*this);
    CGCallee Callee = CGCallee::forDirect(LgammalFn, CGCalleeInfo{});
    return EmitWrappedPositBuiltinCall(*this, E, nullptr, Callee, ReturnValue, nullptr);
  }
  break;
  ...
  if (getLangOpts().Fposit) {
    llvm::Function *IlogblFn = getOrDeclareilogbl(*this);
    CGCallee Callee = CGCallee::forDirect(IlogblFn, CGCalleeInfo{});
    return EmitWrappedPositBuiltinCall(*this, E, nullptr, Callee, ReturnValue, nullptr);
  }
  break;
  case Builtin::BIlog2:
  ...
  if (getLangOpts().Fposit) {
    llvm::Function *IlogbFn = getOrDeclareilogb(*this);
    CGCallee Callee = CGCallee::forDirect(IlogbFn, CGCalleeInfo{});
    return EmitWrappedPositBuiltinCall(*this, E, nullptr, Callee, ReturnValue, nullptr);
  }
  break;
  //============================================================//
  ...
  if (getLangOpts().Fposit) {
    if (const FunctionDecl *FD = E->getDirectCallee()) {
      llvm::Value *FnPtr = EmitScalarExpr(E->getCallee());

      QualType QT = FD->getType();
      CanQual<FunctionProtoType> CanFPT = CGM.getContext()
          .getCanonicalType(QT).getAs<FunctionProtoType>();

      const CGFunctionInfo &FuncInfo = CGM.getTypes()
          .arrangeFreeFunctionType(CanFPT);
      llvm::FunctionType *FTy = CGM.getTypes().GetFunctionType(FuncInfo);

      llvm::FunctionCallee FCallee(FTy, FnPtr);
      CGCalleeInfo CalleeInfo(FD);
      CGCallee Callee = CGCallee::forDirect(FCallee, CalleeInfo);

      return EmitWrappedPositBuiltinCall(*this, E, FD, Callee, ReturnValue, nullptr);
    }
  }
  break;
