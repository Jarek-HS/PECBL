...
private:
  ...
  /// \name Posit value
  ///@{
  integerPart *posit_significand();
  bool *posit_tag();
  int *posit_ischange();
  const integerPart *posit_significand() const;
  const bool *posit_tag() const;
  integerPart *posit_exponent();
  integerPart *posit_regime();
  integerPart *posit_fraction();
  integerPart *posit_sign();
  /// @}
