...
public:
  ...
  //posit
  static void tcPosit (WordType *,const WordType *);
  static void tcinitPosit(WordType * ,WordType *,WordType *,WordType*,WordType*,bool*,int *);
  static void tcAssignPoist(WordType *, const WordType *,bool *, const bool *);
