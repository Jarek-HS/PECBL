...
void APInt::tcPosit(WordType *dst, const WordType *scr) {
  WordType value = *scr;
  *dst = value;
}
void APInt::tcinitPosit(WordType *value,WordType *exponent,WordType *regime,WordType*fraction,WordType*sign,bool *tag,int *change) {
  *value = 0;
  *exponent = 0;
  *regime = 0;
  *fraction =0;
...
void APInt::tcAssignPoist(WordType *dst, const WordType *scr,bool *dst_tag,const bool *src_tag) {
  WordType value = *scr;
  *dst = value;
  *dst_tag = *src_tag;
}
